        ...
        <div className="col-span-8">
          {selectedFile ? (
            <>
              ...
              <div className="mb-6 p-4 border rounded-lg bg-black shadow-sm">
                <h3 className="text-xl font-semibold mb-4 text-white">Search Context</h3>
                <div className="space-y-4 max-h-[300px] overflow-y-auto">
                  {searchResults.map((result, idx) => (
                    <div key={idx} className="p-4 border rounded bg-gray-900">
                      ...
                      <p className="text-sm whitespace-pre-wrap text-white">{result.text}</p>
                    </div>
                  ))}
